...
var CCGame_Logo = {
    CCLogo:"res/Game/Maj/ChangChun/Resoures/room/img_changchun_logo.png",
}


MJChangChun.Common = {
    GameStatus  : MJChangChunGameStatus,
    TipRes      : MJChangChunTipRes,
    HuSound     : MJChangChunHuSound,
    HuWord      : MJChangChunHuWord,
    HuRes       : MJChangChunDaHuRes,
};
