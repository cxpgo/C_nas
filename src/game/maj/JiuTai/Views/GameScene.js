...
MJJiuTai.GameScene = function () {
	var _GameStatus = MJJiuTaiGameStatus;
	var _GameDesk = MJGameDesk;
	var _RecordControll = MJJiuTai.RecordControll;
	...
	var GameRoom = MJGameRoomBase.extend({
		setOption: function () {
			...
			this.UIPlugIns = [
				...
				{
					V2D: MJJiuTai.RES.WGRoomBaoPai,
					V3D: MJJiuTai.RES.WGRoomBaoPai3D,
				},
			];
		},
		ctor: function () {
			...
			MJDaHuAni.register(MJJiuTai.DahuAnim);
			MJGameDesk.registCfg(MJJiuTai.DeskCfg);
			var root = this.mRoot;
			var _this = this;
		...
		addSelfDesk: function () {
            ...
            XYGLogic.Instance.SeatPlayerInfo[XYGLogic.Instance.selfSeatInfo().uid] = this.seat_left;
