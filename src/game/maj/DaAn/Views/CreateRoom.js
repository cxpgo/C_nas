MJDaAn.WGCreateRoom = ccui.Layout.extend({
    mCacheTag : "config_daan_",
    ctor: function () {
        var root = util.LoadUI(MJDaAn.RES.WGCRoom).node;
        this._super(root);
        ...
        this.mRoomData['queMen'] = 1;
        this.mRoomData['tableName'] = 'daan';
        this.mRoomData['serverType'] = 'daan';
    ...
    optView: function () {
        ...
        for (var i = 0; i < opKeys.length; i++) {
            ...
            checkbox.setTouchEnabled(false);
            panel._checkBox = checkbox;
            // var saveOp = util.getCacheItem(this.mCacheTag + 'queMen');
            //
            // if (saveOp === "0" || saveOp === 1) {
            //     this.mRoomData["queMen"] = parseInt(saveOp);
            // }
            // var bl = this.mRoomData["queMen"] === queMenCfgVs[i];
    ...
    getCreateRoomData:function () {
        var roomData = {};
        roomData['appId'] = MJDaAn.Game.appId;
