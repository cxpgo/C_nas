MJSongYuan.WGCreateRoom = ccui.Layout.extend({
    mCacheTag : "config_songyuan_",
    ctor: function () {
        var root = util.LoadUI(MJSongYuan.RES.WGCRoom).node;
        this._super(root);
        ...
        this.mRoomData['tableName'] = 'songyuan';
        this.mRoomData['serverType'] = 'songyuan';
    ...
    getCreateRoomData:function () {
        var roomData = {};
        roomData['appId'] = MJSongYuan.Game.appId;
