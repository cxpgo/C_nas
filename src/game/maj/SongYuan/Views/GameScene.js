...
MJSongYuan.GameScene = function () {
	var _GameStatus = MJSongYuanGameStatus;
	var _GameDesk = MJGameDesk;
	var _RecordControll = MJSongYuan.RecordControll;
	...
	var GameRoom = MJGameRoomBase.extend({
		setOption: function () {
			...
			this.UIPlugIns = [
				...
				{
					V2D: MJSongYuan.RES.WGRoomBaoPai,
					V3D: MJSongYuan.RES.WGRoomBaoPai3D,
				},
			];
		},
		ctor: function () {
			...
			MJDaHuAni.register(MJSongYuan.DahuAnim);
			MJGameDesk.registCfg(MJSongYuan.DeskCfg);
			var root = this.mRoot;
			var _this = this;
		...
		onEnter: function () {
			this._super();
			MJSoundMgr.RegistMJAudioPath(MJSongYuan.RESPath+"Resoures/audio/");
