var GameStateSeating = GameBaseState.extend({
    ctor: function (status ) {
        this._super(status , "seating");
    },
    onInit: function () {
        this._super();
        qp.event.listen(this, 'mjReadyStatus', this.onReadyStatus.bind(this));

        this.setBeneathCards([{"type":0x00,"value":0x00} ,{"type":0x00,"value":0x00} , {"type":0x00,"value":0x00}]);
