...
var DDZRecordLogic = function () {
    var logic = cc.Class.extend({
        ...
        initSeatInfo: function (data) {
            ...
            this.bankerCards = data['bankerCards'] || {};
            this.checkNum = data['checkNum'] || 0;
            if (data.isLaiZi == 1) {
                this.changeValue = data["changeValue"];
                XYGLogic.Instance.changeValue = data["changeValue"];
            }
        ...
        initDirArr: function (data) {
            ...
            if (this.person == 2) {
                this.dirArr[this.UP] = this.dirArr[this.SELF] == 1 ? 0 : 1;
            } else {
        ...
        runToRecord: function () {
            var game = new DDZGameSceneRecord();
            game.runToRecord();
        },
    });
