 ...
 */
var DDZDeskHead = cc.Layer.extend({
    playerData: null,
    text_name: null,
    text_score: null,
    panel_root: null,
    ...
    ctor: function (data) {
        ...
        this.uid = data["uid"];
        var root = util.LoadUI(DDZPokerJson.Head).node;
        this.addChild(root);
        ...
        this.text_name.setString(cutStringLenght(base64.decode(this.playerData["nickName"])));
        ...
        var sprite_fangzhu = ccui.helper.seekWidgetByName(root, "sprite_fangzhu");
        sprite_fangzhu.setVisible( (this.uid == XYGLogic.Instance.whoIsFangzhu()) );
    ...
    onEnter: function () {
        ...
        if (pos.x < size.width * 0.5) {
            ...
            this.sprite_banker.setPositionX(100);
            this.isRight = true;
    ...
    resetBakerShow: function () {
        this.sprite_banker.setVisible( (this.uid == XYGLogic.Instance.whoIsBanker()) );        
    },
    recordResetBakerShow: function () {
        this.sprite_banker.setVisible( (this.uid == XYGLogic.record.banker) );
    },
